...
![image-20210406114945080](C:\Users\86138\AppData\Roaming\Typora\typora-user-images\image-20210406114945080.png)  
...
计算self_attention的第二步是计算score值：

+ 对输入句子中的每个单词和当前词分别计算得分(score值)，score值决定了对输入句子的其它部分的关注程度。
+ score值的计算：当前词的query向量和要打分的每个单词的key向量做点积运算。
